...
namespace ptmp {
    namespace testing {
        ...
        // Data time is expressed in units of hardware clock "ticks".
        // For protodune this is the 50MHz clock.

        // Update just the count and time values.  Needs count to be
        // previously initialized to something.
